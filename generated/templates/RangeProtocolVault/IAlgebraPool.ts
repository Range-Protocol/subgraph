...
export class IAlgebraPool__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class IAlgebraPool__collectResult {
  value0: BigInt;
  value1: BigInt;
...
export class IAlgebraPool__globalStateResult {
  value0: BigInt;
  value1: i32;
  value2: i32;
  value3: i32;
...
export class IAlgebraPool__mintResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class IAlgebraPool__positionsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class IAlgebraPool__swapResult {
  value0: BigInt;
  value1: BigInt;
...
export class IAlgebraPool__ticksResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class IAlgebraPool extends ethereum.SmartContract {
  static bind(address: Address): IAlgebraPool {
    return new IAlgebraPool("IAlgebraPool", address);
  }
  ...
  burn(
    ...
    return new IAlgebraPool__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_burn(
    ...
    topTick: i32,
    amount: BigInt
  ): ethereum.CallResult<IAlgebraPool__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new IAlgebraPool__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  collect(
    ...
    return new IAlgebraPool__collectResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collect(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<IAlgebraPool__collectResult> {
    let result = super.tryCall(
      "collect",
      "collect(address,int24,int24,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new IAlgebraPool__collectResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  globalState(): IAlgebraPool__globalStateResult {
    ...
    return new IAlgebraPool__globalStateResult(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_globalState(): ethereum.CallResult<IAlgebraPool__globalStateResult> {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new IAlgebraPool__globalStateResult(
        value[0].toBigInt(),
        value[1].toI32(),
        value[2].toI32(),
        value[3].toI32(),
  ...
  mint(
    ...
    return new IAlgebraPool__mintResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_mint(
    ...
    amount: BigInt,
    data: Bytes
  ): ethereum.CallResult<IAlgebraPool__mintResult> {
    let result = super.tryCall(
      "mint",
      "mint(address,address,int24,int24,uint128,bytes):(uint256,uint256,uint128)",
      [
  ...
  positions(key: Bytes): IAlgebraPool__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new IAlgebraPool__positionsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_positions(
    key: Bytes
  ): ethereum.CallResult<IAlgebraPool__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(bytes32):(uint128,uint32,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromFixedBytes(key)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new IAlgebraPool__positionsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  swap(
    ...
    return new IAlgebraPool__swapResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_swap(
    ...
    limitSqrtPrice: BigInt,
    data: Bytes
  ): ethereum.CallResult<IAlgebraPool__swapResult> {
    let result = super.tryCall(
      "swap",
      "swap(address,bool,int256,uint160,bytes):(int256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new IAlgebraPool__swapResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  ticks(tick: i32): IAlgebraPool__ticksResult {
    let result = super.call(
      "ticks",
    ...
    return new IAlgebraPool__ticksResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_ticks(tick: i32): ethereum.CallResult<IAlgebraPool__ticksResult> {
    let result = super.tryCall(
      "ticks",
      "ticks(int24):(uint128,int128,uint256,uint256,int56,uint160,uint32,bool)",
      [ethereum.Value.fromI32(tick)]
